...
7.  **[Worker Pool Module](worker_pool/README.md)**
    *   **[Worker Pool Guide](worker_pool/worker_pool.md)**: Standalone worker process pool for parallel task execution, with persistent workers, crash recovery, lifecycle hooks, and graceful shutdown.
