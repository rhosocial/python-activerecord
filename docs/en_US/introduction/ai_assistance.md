...
**Development:**
- `/test` — Run all tests
- `/test:feature query` — Run specific feature tests
- `/lint` / `/lint:fix` — Code style checking
...
> "Check @sync-async-parity — this method needs an async counterpart."
...
> 🤖 **Throughout this documentation, look for 💡 AI Prompt markers next to complex concepts. Feel free to ask your AI assistant to explain anything you don't understand.**
