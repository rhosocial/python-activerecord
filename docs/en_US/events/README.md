...
Complete example code for this chapter can be found at `docs/examples/chapter_08_events/`.

| File | Description |
|------|-------------|
| [01_lifecycle_hooks.py](../../examples/chapter_08_events/01_lifecycle_hooks.py) | Lifecycle hooks: before_save, after_save, before_delete, after_delete |
| [02_event_listeners.py](../../examples/chapter_08_events/02_event_listeners.py) | Event listeners: using on() method, multiple listeners, dynamic registration |
| [03_mixin_pattern.py](../../examples/chapter_08_events/03_mixin_pattern.py) | Mixin pattern: reusable event logic, combining multiple Mixins
