...
Complete example code for this chapter can be found at `docs/examples/chapter_11_serialization/`.

| File | Description |
|------|-------------|
| [01_basic_serialization.py](../../examples/chapter_11_serialization/01_basic_serialization.py) | Basic serialization: model_dump(), model_dump_json(), field types |
| [02_field_filtering.py](../../examples/chapter_11_serialization/02_field_filtering.py) | Field filtering: exclude, include, nested filtering, context-aware |
| [03_related_data.py](../../examples/chapter_11_serialization/03_related_data.py) | Related data: serializing relationships, computed_field, nested patterns |
