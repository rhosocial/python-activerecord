...
* [rhosocial-activerecord Documentation](README.md)

## Introduction

* [Overview](introduction/README.md)
* [AI-Assisted Development](introduction/ai_assistance.md)
* [Glossary](introduction/glossary.md)
* [Coming from Other Frameworks](introduction/coming_from_frameworks.md)
* [Philosophy](introduction/philosophy.md)
* [Key Features](introduction/key_features.md)
* [Technical Decision Guide](introduction/comparison.md)
* [Architecture](introduction/architecture.md)

### Competitor Analysis

* [Overview](introduction/competitor_analysis/README.md)
...
* [Summary](introduction/competitor_analysis/summary.md)
...
* [First CRUD App](getting_started/first_crud.md)
...
* [Overview](relationships/README.md)
...
* [Overview](connection/README.md)
* [Connection Groups & Manager](connection/connection_management.md)
* [Connection Pool](connection/connection_pool.md)

## Worker Pool Module

* [Overview](worker_pool/README.md)
* [Worker Pool Guide](worker_pool/worker_pool.md)
* [Task Guide](worker_pool/task_guide.md)
* [Lifecycle Hooks](worker_pool/lifecycle_hooks.md)
* [Management & Statistics](worker_pool/management_statistics.md)
* [API Reference](worker_pool/api_reference.md)
* [Best Practices](worker_pool/best_practices.md)
...
* [Overview](logging/README.md)
* [Logger Namespace](logging/namespace.md)
* [Data Summarization](logging/data_summarization.md)
* [Per-Logger Configuration](logging/per_logger_config.md)
...
* [Overview](backend/expression/README.md)
