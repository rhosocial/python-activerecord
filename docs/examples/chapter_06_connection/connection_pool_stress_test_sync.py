...
def main():
    ...
    try:
        ...
        print("  0 = None (not thread-safe)")
        print("  1 = sqlite3 (only supports SQL)")
        print("  2 = Full thread-safe")
        ...
        with ThreadPoolExecutor(max_workers=num_workers) as executor:
            futures = [executor.submit(worker_thread, pool, i, iterations, lock) for i in range(num_workers)]
