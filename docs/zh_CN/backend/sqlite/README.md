...
3. **[SQLite 特有功能](backend_specific_features/README.md)**
    *   **[Pragma 系统](backend_specific_features/pragma.md)**：SQLite PRAGMA 配置与查询
    *   **[扩展框架](backend_specific_features/extension.md)**：扩展检测与管理
    *   **[全文搜索 (FTS5)](backend_specific_features/fts5.md)**：FTS5 全文搜索功能
...
4. **[事务支持](transaction_support/README.md)**
    *   **[事务概述](transaction_support/README.md)**：事务管理器 API
    *   **[保存点](transaction_support/README.md#savepoints)**：嵌套事务
    *   **[隔离级别](transaction_support/README.md#isolation-level)**：SQLite 隔离语义

5. **[类型适配器](type_adapters/README.md)**
    *   **[类型映射](type_adapters/README.md#type-mapping)**：SQLite 到 Python 类型转换
    *   **[特殊类型](type_adapters/README.md#special-types)**：datetime、UUID、Decimal、JSON 支持

6. **[测试](testing/README.md)**
    *   **[测试原则](testing/README.md)**：同步/异步对等、表达式测试、testsuite 使用

7. **[故障排除](troubleshooting/README.md)**
    *   **[常见问题](troubleshooting/README.md)**：数据库锁定、WAL 模式等 SQLite 陷阱

8. **[应用场景](scenarios/README.md)**
    *   **[并发特性](scenarios/README.md)**：文件锁、网络存储与部署模式

9. **[自定义](customization/README.md)**
    *   **[自定义表达式](customization/README.md#custom-expressions)**：SQLite 特有 SQL 语法
    *   **[自定义类型](customization/README.md#custom-data-types)**：扩展类型系统
    *   **[自定义适配器](customization/README.md#custom-type-adapters)**：注册类型转换器

10. **[命令行界面](cli/README.md)**
