...
description: End-to-end version control runbook for rhosocial-activerecord - branching, pre-release lifecycle (dev/alpha/beta/rc), release to main, hotfixes, backports, towncrier changelog, multi-version support, and CI configuration
license: MIT
