...
def create_users_table(dialect, table_name: str = "users") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "is_active", IntegerType(),
                constraints=[
                    ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
...
def create_comments_table(dialect, table_name: str = "comments") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "user_id", IntegerType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "post_id", IntegerType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "content", TextType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "is_hidden", IntegerType(),
                constraints=[
                    ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
...
def create_profiles_table(dialect, table_name: str = "profiles") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "user_id", IntegerType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "bio", TextType()),
            ColumnDefinition(dialect, "avatar_url", TextType()),
            ColumnDefinition(dialect, "created_at", TextType()),
            ColumnDefinition(dialect, "updated_at", TextType()),
        ],
        table_constraints=[
...
def create_orders_table(dialect, table_name: str = "orders") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "user_id", IntegerType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "order_number", TextType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "total_amount", DecimalType(precision=10, scale=2),
                constraints=[
                    ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
                    ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value=Decimal("0.00")),
                ]),
    ...
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "order_id", IntegerType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "product_name", TextType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ...
            ColumnDefinition(dialect, "unit_price", DecimalType(precision=10, scale=2),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "subtotal", DecimalType(precision=10, scale=2),
                constraints=[
                    ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
                    ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value=Decimal("0.00")),
                ]),
...
def create_extended_orders_table(dialect, table_name: str = "extended_orders") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "priority", TextType(),
            ...
            ColumnDefinition(dialect, "category", TextType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value="")]),
            ColumnDefinition(dialect, "product", TextType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value="")]),
            ColumnDefinition(dialect, "department", TextType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value="")]),
            ColumnDefinition(dialect, "year", TextType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value="")]),
            ColumnDefinition(dialect, "quarter", TextType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value="")]),
            ColumnDefinition(dialect, "created_at", TextType()),
            ColumnDefinition(dialect, "updated_at", TextType()),
        ],
...
def create_json_users_table(dialect, table_name: str = "json_users") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "profile", TextType()),
            ColumnDefinition(dialect, "roles", TextType()),
            ColumnDefinition(dialect, "scores", TextType()),
            ColumnDefinition(dialect, "subscription", TextType()),
            ColumnDefinition(dialect, "preferences", TextType()),
            ColumnDefinition(dialect, "created_at", TextType()),
            ColumnDefinition(dialect, "updated_at", TextType()),
        ],
    )
    ...
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "name", VarCharType(100),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "parent_id", IntegerType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value=RawSQLExpression(dialect, "NULL"))]),
            ColumnDefinition(dialect, "value", DecimalType(precision=10, scale=2),
            ...
            ColumnDefinition(dialect, "updated_at", TimestampType(),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value=RawSQLExpression(dialect, "CURRENT_TIMESTAMP"))]),
        ],
        table_constraints=[
            ForeignKeyConstraint(dialect, 
