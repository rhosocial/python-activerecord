...
def skip_if_not_sqlite(request):
    """Skip tests if not using SQLite backend."""
    if 'sqlite' not in request.node.name:
        pytest.skip("This test is only applicable to SQLite")


def test_explain_json_expressions(json_fixtures, skip_if_not_sqlite):
...
def test_explain_json_text(json_fixtures, skip_if_not_sqlite):
...
def test_explain_json_contains(json_fixtures, skip_if_not_sqlite):
...
def test_explain_json_exists(json_fixtures, skip_if_not_sqlite):
...
def test_explain_json_type(json_fixtures, skip_if_not_sqlite):
...
def test_explain_json_modification(json_fixtures, skip_if_not_sqlite):
