# tests/rhosocial/activerecord_test/query/sqlite/test_explain_expressions.py
...
def test_explain_arithmetic_expression(order_fixtures, request):
...
def test_explain_function_expression(order_fixtures, request):
...
def test_explain_conditional_expression(order_fixtures, request):
...
def test_explain_case_expression(order_fixtures, request):
...
def test_explain_complex_expressions(order_fixtures, request):
...
def test_explain_subquery_expression(order_fixtures, request):
...
def test_explain_expression_with_joins(order_fixtures, request):
...
def test_explain_expression_with_grouping(order_fixtures, request):
