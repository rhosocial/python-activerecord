# tests/rhosocial/activerecord_test/query/sqlite/test_explain_cte_multiple.py
...
def test_explain_multiple_ctes(order_fixtures, request):
...
def test_explain_cte_with_join(order_fixtures, request):
...
def test_explain_cte_with_or_conditions(order_fixtures, request):
