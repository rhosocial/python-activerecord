# tests/rhosocial/activerecord_test/query/sqlite/test_explain_arithmetic.py
...
def test_explain_basic_arithmetic(order_fixtures, request):
...
def test_explain_complex_arithmetic(order_fixtures, request):
...
def test_explain_arithmetic_with_aggregates(order_fixtures, request):
...
def test_explain_arithmetic_with_joins(order_fixtures, request):
...
def test_explain_arithmetic_with_case(order_fixtures, request):
...
def test_explain_complex_arithmetic_expressions(order_fixtures, request):
...
def test_explain_arithmetic_with_subquery(order_fixtures, request):
