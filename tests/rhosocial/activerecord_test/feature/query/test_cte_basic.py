# tests/rhosocial/activerecord_test/feature/query/test_cte_basic.py
"""
This is a "bridge" file for the query CTE basic features test group.
...
# By importing *, we bring all the test functions (e.g., `test_basic_cte`)
