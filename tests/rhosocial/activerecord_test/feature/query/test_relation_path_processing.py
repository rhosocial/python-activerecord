# tests/rhosocial/activerecord_test/feature/query/test_relation_path_processing.py
"""
This is a "bridge" file for the query relation_path_processing test group.
