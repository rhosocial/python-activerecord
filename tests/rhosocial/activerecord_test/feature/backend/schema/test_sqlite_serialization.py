# tests/rhosocial/activerecord_test/feature/backend/schema/test_sqlite_serialization.py
"""
...
class TestSQLiteSpecificExpressionSerialization:
    ...
    def test_reindex_expression_with_dialect_options(self, sqlite_dialect):
        ...
        expr = SQLiteReindexExpression(sqlite_dialect, table="users", dialect_options={"temp": True})
        spec = serialize(expr)
