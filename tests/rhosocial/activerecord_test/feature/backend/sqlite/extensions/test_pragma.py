# tests/rhosocial/activerecord_test/feature/backend/sqlite/extensions/test_pragma.py
import logging
import os
import tempfile
...
class TestSQLitePragma:
    ...
    def test_temp_store_pragma(self, temp_db_path):
        ...
        # temp_store is enum-whitelisted: only DEFAULT/FILE/MEMORY spellings
