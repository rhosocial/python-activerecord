# tests/rhosocial/activerecord_test/feature/backend/introspection/test_status_introspector.py
"""
Tests for SQLite status introspector.

This module tests the SyncSQLiteStatusIntrospector functionality
...
class TestSyncSQLiteStatusIntrospector:
    """Tests for synchronous SQLite status introspector."""

    def test_get_overview(self, sqlite_backend):
        """Test get_overview returns valid ServerOverview."""
        status = sqlite_backend.introspector.status
    ...
    def test_get_overview_version_matches_dialect(self, sqlite_backend):
        """Test that overview version matches dialect version."""
        status = sqlite_backend.introspector.status
        overview = status.get_overview()

        expected_version = ".".join(map(str, sqlite_backend.dialect.version))
        assert overview.server_version == expected_version

    def test_get_overview_contains_sqlite_version_info(self, sqlite_backend):
    ...
    def test_list_configuration(self, sqlite_backend):
    ...
    def test_list_configuration_with_category_filter(self, sqlite_backend):
    ...
    def test_list_configuration_contains_expected_items(self, sqlite_backend):
    ...
    def test_list_configuration_values_are_parsed(self, sqlite_backend):
    ...
    def test_list_performance_metrics(self, sqlite_backend):
    ...
    def test_get_connection_info(self, sqlite_backend):
    ...
    def test_get_storage_info_memory_database(self, sqlite_backend):
    ...
    def test_get_storage_info_file_database(self, sqlite_file_backend):
    ...
    def test_get_storage_info_data_size(self, sqlite_file_backend):
    ...
    def test_list_databases_main_only(self, sqlite_backend):
    ...
    def test_list_databases_file_database(self, sqlite_file_backend):
    ...
    def test_list_users(self, sqlite_backend):
    ...
    def test_status_item_has_description(self, sqlite_backend):
    ...
    def test_status_item_readonly_flag(self, sqlite_backend):
...
class TestSQLiteStatusIntrospectorMixin:
    """Tests for SQLiteStatusIntrospectorMixin helper methods."""

    def test_parse_pragma_value_int(self, sqlite_backend):
    ...
    def test_parse_pragma_value_str_int(self, sqlite_backend):
    ...
    def test_parse_pragma_value_str_non_int(self, sqlite_backend):
    ...
    def test_get_database_file_info_memory(self, sqlite_backend):
    ...
    def test_get_database_file_info_file(self, sqlite_file_backend):
        """Test _get_database_file_info for file database."""
        status = sqlite_file_backend.introspector.status
        db_path = sqlite_file_backend.config.database
    ...
    def test_create_status_item(self, sqlite_backend):
    ...
    def test_get_vendor_name(self, sqlite_backend):
...
class TestStatusIntrospectorWithAttachedDatabase:
    """Tests for status introspector with attached databases."""

    def test_list_databases_with_attached(self, sqlite_file_backend):
...
class TestStatusIntrospectorStorageCategories:
    """Tests for different status categories."""

    def test_configuration_category_items(self, sqlite_backend):
    ...
    def test_performance_category_items(self, sqlite_backend):
    ...
    def test_storage_category_items(self, sqlite_backend):
    ...
    def test_security_category_items(self, sqlite_backend):
