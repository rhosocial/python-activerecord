...
class TestValuesExpression:
    ...
    def test_values_expression_basic(self, dummy_dialect: DummyDialect):
        ...
        values_data = [(1, "Alice", 25), (2, "Bob", 30), (3, "Charlie", 35)]

        values_expr = ValuesExpression(
            dummy_dialect, values=values_data, alias="user_data", column_names=["id", "name", "age"]
        )
    ...
    def test_values_expression_single_row(self, dummy_dialect: DummyDialect):
        ...
        values_data = [(100, "Test Name", "test@example.com")]

        values_expr = ValuesExpression(
            dummy_dialect, values=values_data, alias="single_row", column_names=["id", "name", "email"]
        )
    ...
    def test_values_expression_with_different_types(self, dummy_dialect: DummyDialect):
        ...
        values_data = [(1, "string", 3.14, True, None), (2, "another", 2.71, False, "value")]
    ...
    def test_values_expression_empty_values(self, dummy_dialect: DummyDialect):
        ...
        values_expr = ValuesExpression(dummy_dialect, values=[], alias="empty_values", column_names=["id", "name"])
    ...
    def test_values_expression_single_column_multiple_rows(self, dummy_dialect: DummyDialect):
        ...
        values_data = [("value1",), ("value2",), ("value3",)]

        values_expr = ValuesExpression(dummy_dialect, values=values_data, alias="single_col", column_names=["name"])
    ...
    def test_values_expression_used_in_query_from_clause(self, dummy_dialect: DummyDialect):
        ...
        values_data = [(1, "Product A", 10.99), (2, "Product B", 15.99)]

        values_expr = ValuesExpression(
            dummy_dialect, values=values_data, alias="products", column_names=["id", "name", "price"]
        )

        # Create a query using the VALUES expression as FROM
        query = QueryExpression(
            dummy_dialect,
            select=[Column(dummy_dialect, "name", table="products"), Column(dummy_dialect, "price", table="products")],
    ...
    def test_values_expression_alias_formatting(self, dummy_dialect: DummyDialect):
        ...
        values_expr = ValuesExpression(
            dummy_dialect, values=values_data, alias="test_alias", column_names=["id", "name"]
        )
    ...
    def test_values_expression_column_names_formatting(self, dummy_dialect: DummyDialect):
        ...
        values_expr = ValuesExpression(
            dummy_dialect, values=values_data, alias="users", column_names=["user_id", "user_name"]
        )
    ...
    def test_values_expression_complex_values(self, dummy_dialect: DummyDialect):
        ...
        values_data = [(1, ["tag1", "tag2"], {"key": "value"}), (2, ["tag3", "tag4"], {"key2": "value2"})]

        values_expr = ValuesExpression(
            dummy_dialect, values=values_data, alias="complex_data", column_names=["id", "tags", "metadata"]
        )
    ...
    def test_values_expression_large_dataset(self, dummy_dialect: DummyDialect):
        ...
        values_expr = ValuesExpression(
            dummy_dialect, values=values_data, alias="large_data", column_names=["id", "name", "value"]
        )
    ...
    def test_values_expression_without_alias(self, dummy_dialect: DummyDialect):
        ...
        values_data = [(1, "Alice", 25), (2, "Bob", 30)]

        # Create ValuesExpression without alias
        values_expr = ValuesExpression(dummy_dialect, values=values_data, column_names=["id", "name", "age"])
