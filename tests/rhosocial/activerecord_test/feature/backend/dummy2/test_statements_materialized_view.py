...
class TestCreateMaterializedViewStatements:
    ...
    def test_basic_create_materialized_view(self, dummy_dialect: DummyDialect):
        ...
        create_mv = CreateMaterializedViewExpression(dummy_dialect, view_name="user_summary", query=query)
    ...
    def test_create_materialized_view_with_aggregates(self, dummy_dialect: DummyDialect):
        ...
        create_mv = CreateMaterializedViewExpression(dummy_dialect, view_name="order_summary", query=query)
        sql, params = create_mv.to_sql()
    ...
    def test_create_materialized_view_with_column_aliases(self, dummy_dialect: DummyDialect):
        ...
        create_mv = CreateMaterializedViewExpression(
            dummy_dialect, view_name="user_totals", query=query, column_aliases=["user_id", "total_amount"]
        )
        sql, params = create_mv.to_sql()
    ...
    def test_create_materialized_view_with_tablespace(self, dummy_dialect: DummyDialect):
        ...
        query = QueryExpression(
            dummy_dialect, select=[Column(dummy_dialect, "id")], from_=TableExpression(dummy_dialect, "products")
        )

        create_mv = CreateMaterializedViewExpression(
            dummy_dialect, view_name="product_cache", query=query, tablespace="fast_storage"
        )
        sql, params = create_mv.to_sql()
    ...
    def test_create_materialized_view_with_no_data(self, dummy_dialect: DummyDialect):
        ...
        create_mv = CreateMaterializedViewExpression(
            dummy_dialect, view_name="category_mv", query=query, with_data=False
        )
        sql, params = create_mv.to_sql()
...
class TestDropMaterializedViewStatements:
    ...
    def test_basic_drop_materialized_view(self, dummy_dialect: DummyDialect):
        ...
        drop_mv = DropMaterializedViewExpression(dummy_dialect, view_name="old_summary")
    ...
    def test_drop_materialized_view_with_if_exists(self, dummy_dialect: DummyDialect):
        ...
        drop_mv = DropMaterializedViewExpression(dummy_dialect, view_name="possibly_missing_mv", if_exists=True)
        sql, params = drop_mv.to_sql()
    ...
    def test_drop_materialized_view_with_cascade(self, dummy_dialect: DummyDialect):
        ...
        drop_mv = DropMaterializedViewExpression(dummy_dialect, view_name="parent_mv", cascade=True)
        sql, params = drop_mv.to_sql()
    ...
    def test_drop_materialized_view_if_exists_cascade(self, dummy_dialect: DummyDialect):
        ...
        drop_mv = DropMaterializedViewExpression(dummy_dialect, view_name="dependent_mv", if_exists=True, cascade=True)
        sql, params = drop_mv.to_sql()
...
class TestRefreshMaterializedViewStatements:
    ...
    def test_basic_refresh_materialized_view(self, dummy_dialect: DummyDialect):
        ...
        refresh_mv = RefreshMaterializedViewExpression(dummy_dialect, view_name="user_summary")
    ...
    def test_refresh_materialized_view_concurrent(self, dummy_dialect: DummyDialect):
        ...
        refresh_mv = RefreshMaterializedViewExpression(dummy_dialect, view_name="product_stats", concurrent=True)
        sql, params = refresh_mv.to_sql()
    ...
    def test_refresh_materialized_view_with_data(self, dummy_dialect: DummyDialect):
        ...
        refresh_mv = RefreshMaterializedViewExpression(dummy_dialect, view_name="sales_summary", with_data=True)
        sql, params = refresh_mv.to_sql()
    ...
    def test_refresh_materialized_view_with_no_data(self, dummy_dialect: DummyDialect):
        ...
        refresh_mv = RefreshMaterializedViewExpression(dummy_dialect, view_name="empty_view", with_data=False)
        sql, params = refresh_mv.to_sql()
    ...
    def test_refresh_materialized_view_concurrent_with_data(self, dummy_dialect: DummyDialect):
        ...
        refresh_mv = RefreshMaterializedViewExpression(
            dummy_dialect, view_name="complex_stats", concurrent=True, with_data=True
        )
        sql, params = refresh_mv.to_sql()
...
class TestMaterializedViewRoundtrip:
    ...
    def test_materialized_view_create_drop_refresh_cycle(self, dummy_dialect: DummyDialect):
        ...
        query = QueryExpression(
            ...
            group_by_having=GroupByHavingClause(dummy_dialect, group_by=[Column(dummy_dialect, "department")]),
        )

        # Create
        create_mv = CreateMaterializedViewExpression(dummy_dialect, view_name="dept_avg_salary", query=query)
        create_sql, create_params = create_mv.to_sql()

        # Refresh
        refresh_mv = RefreshMaterializedViewExpression(dummy_dialect, view_name="dept_avg_salary")
        refresh_sql, refresh_params = refresh_mv.to_sql()

        # Drop
        drop_mv = DropMaterializedViewExpression(dummy_dialect, view_name="dept_avg_salary")
    ...
    def test_materialized_view_various_names(self, dummy_dialect: DummyDialect, view_name: str):
        ...
        create_mv = CreateMaterializedViewExpression(dummy_dialect, view_name=view_name, query=query)
        sql, params = create_mv.to_sql()
