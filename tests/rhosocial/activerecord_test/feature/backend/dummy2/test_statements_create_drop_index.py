...
class TestCreateDropIndexStatements:
    ...
    def test_basic_create_index(self, dummy_dialect: DummyDialect):
        ...
        create_index = CreateIndexExpression(
            dummy_dialect, index_name="idx_users_email", table_name="users", columns=["email"]
        )
    ...
    def test_create_unique_index(self, dummy_dialect: DummyDialect):
        ...
        create_index = CreateIndexExpression(
            dummy_dialect, index_name="idx_users_username", table_name="users", columns=["username"], unique=True
        )
        sql, params = create_index.to_sql()
    ...
    def test_create_index_if_not_exists(self, dummy_dialect: DummyDialect):
        ...
        create_index = CreateIndexExpression(
            dummy_dialect, index_name="idx_users_email", table_name="users", columns=["email"], if_not_exists=True
        )
        sql, params = create_index.to_sql()
    ...
    def test_create_composite_index(self, dummy_dialect: DummyDialect):
        ...
        create_index = CreateIndexExpression(
            dummy_dialect, index_name="idx_orders_user_date", table_name="orders", columns=["user_id", "created_at"]
        )
        sql, params = create_index.to_sql()
    ...
    def test_create_index_with_type(self, dummy_dialect: DummyDialect):
        ...
        create_index = CreateIndexExpression(
            dummy_dialect, index_name="idx_users_name_hash", table_name="users", columns=["name"], index_type="HASH"
        )
        sql, params = create_index.to_sql()
    ...
    def test_create_index_with_include(self, dummy_dialect: DummyDialect):
        ...
        create_index = CreateIndexExpression(
            dummy_dialect, index_name="idx_users_email", table_name="users", columns=["email"], include=["id", "name"]
        )
        sql, params = create_index.to_sql()
    ...
    def test_create_index_with_tablespace(self, dummy_dialect: DummyDialect):
        ...
        create_index = CreateIndexExpression(
            dummy_dialect, index_name="idx_large_table", table_name="large_table", columns=["id"], tablespace="fast_ssd"
        )
        sql, params = create_index.to_sql()
    ...
    def test_create_index_with_expression_column(self, dummy_dialect: DummyDialect):
        ...
        create_index = CreateIndexExpression(
            dummy_dialect, index_name="idx_users_email_lower", table_name="users", columns=[lower_expr]
        )
        sql, params = create_index.to_sql()
    ...
    def test_basic_drop_index(self, dummy_dialect: DummyDialect):
        ...
        drop_index = DropIndexExpression(dummy_dialect, index_name="idx_users_email")
    ...
    def test_drop_index_if_exists(self, dummy_dialect: DummyDialect):
        ...
        drop_index = DropIndexExpression(dummy_dialect, index_name="idx_old_index", if_exists=True)
        sql, params = drop_index.to_sql()
    ...
    def test_drop_index_with_table_name(self, dummy_dialect: DummyDialect):
        ...
        drop_index = DropIndexExpression(dummy_dialect, index_name="idx_orders_status", table_name="orders")
        sql, params = drop_index.to_sql()
    ...
    def test_drop_index_if_exists_with_table_name(self, dummy_dialect: DummyDialect):
        ...
        drop_index = DropIndexExpression(
            dummy_dialect, index_name="idx_old_index", table_name="old_table", if_exists=True
        )
        sql, params = drop_index.to_sql()
    ...
    def test_index_roundtrip_creation_and_deletion(self, dummy_dialect: DummyDialect):
        ...
        create_index = CreateIndexExpression(
            dummy_dialect, index_name="idx_test", table_name="test_table", columns=["id"]
        )
        create_sql, create_params = create_index.to_sql()

        drop_index = DropIndexExpression(dummy_dialect, index_name="idx_test")
    ...
    @pytest.mark.parametrize(
        "index_name,expected_identifier",
        [
    ...
    def test_create_index_various_names(self, dummy_dialect: DummyDialect, index_name, expected_identifier):
        ...
        create_index = CreateIndexExpression(dummy_dialect, index_name=index_name, table_name="users", columns=["id"])
        sql, params = create_index.to_sql()
