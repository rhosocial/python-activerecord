...
import pytest
from rhosocial.activerecord.backend.expression.statements import CreateSchemaExpression, DropSchemaExpression
...
class TestCreateDropSchemaStatements:
    ...
    def test_basic_create_schema(self, dummy_dialect: DummyDialect):
        ...
        create_schema = CreateSchemaExpression(dummy_dialect, schema_name="my_schema")
    ...
    def test_create_schema_with_if_not_exists(self, dummy_dialect: DummyDialect):
        ...
        create_schema = CreateSchemaExpression(dummy_dialect, schema_name="my_schema", if_not_exists=True)
        sql, params = create_schema.to_sql()
    ...
    def test_create_schema_with_authorization(self, dummy_dialect: DummyDialect):
        ...
        create_schema = CreateSchemaExpression(dummy_dialect, schema_name="app_schema", authorization="app_user")
        sql, params = create_schema.to_sql()
    ...
    def test_create_schema_if_not_exists_with_authorization(self, dummy_dialect: DummyDialect):
        ...
        create_schema = CreateSchemaExpression(
            dummy_dialect, schema_name="secure_schema", if_not_exists=True, authorization="admin"
        )
        sql, params = create_schema.to_sql()
    ...
    def test_basic_drop_schema(self, dummy_dialect: DummyDialect):
        ...
        drop_schema = DropSchemaExpression(dummy_dialect, schema_name="old_schema")
    ...
    def test_drop_schema_with_if_exists(self, dummy_dialect: DummyDialect):
        ...
        drop_schema = DropSchemaExpression(dummy_dialect, schema_name="test_schema", if_exists=True)
        sql, params = drop_schema.to_sql()
    ...
    def test_drop_schema_with_cascade(self, dummy_dialect: DummyDialect):
        ...
        drop_schema = DropSchemaExpression(dummy_dialect, schema_name="legacy_schema", cascade=True)
        sql, params = drop_schema.to_sql()
    ...
    def test_drop_schema_if_exists_with_cascade(self, dummy_dialect: DummyDialect):
        ...
        drop_schema = DropSchemaExpression(dummy_dialect, schema_name="deprecated_schema", if_exists=True, cascade=True)
        sql, params = drop_schema.to_sql()
    ...
    @pytest.mark.parametrize(
        "schema_name,expected_identifier",
        [
    ...
    def test_create_schema_various_names(self, dummy_dialect: DummyDialect, schema_name, expected_identifier):
        ...
        create_schema = CreateSchemaExpression(dummy_dialect, schema_name=schema_name)
        sql, params = create_schema.to_sql()
    ...
    def test_schema_roundtrip_creation_and_deletion(self, dummy_dialect: DummyDialect):
        ...
        create_schema = CreateSchemaExpression(dummy_dialect, schema_name="roundtrip_test")
        create_sql, create_params = create_schema.to_sql()

        drop_schema = DropSchemaExpression(dummy_dialect, schema_name="roundtrip_test")
    ...
    def test_schema_with_special_characters(self, dummy_dialect: DummyDialect):
        ...
        create_schema = CreateSchemaExpression(dummy_dialect, schema_name='schema"name')
        sql, params = create_schema.to_sql()
    ...
    def test_schema_with_unicode_characters(self, dummy_dialect: DummyDialect):
        ...
        create_schema = CreateSchemaExpression(dummy_dialect, schema_name="用户模式")
        sql, params = create_schema.to_sql()
