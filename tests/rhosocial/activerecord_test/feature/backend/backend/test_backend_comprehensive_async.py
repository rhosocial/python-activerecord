# tests/rhosocial/activerecord_test/feature/backend/backend/test_backend_comprehensive_async.py
"""
...
class TestAsyncColumnMapping:
    ...
    @pytest.mark.asyncio
    async def test_insert_and_returning_with_mapping(self, async_mapped_table_backend):
        """
    ...
    @pytest.mark.asyncio
    async def test_update_with_backend(self, async_mapped_table_backend):
        """
    ...
    @pytest.mark.asyncio
    async def test_execute_fetch_with_mapping(self, async_mapped_table_backend):
        """
    ...
    @pytest.mark.asyncio
    async def test_execute_fetch_without_mapping(self, async_mapped_table_backend):
        """
    ...
    @pytest.mark.asyncio
    async def test_fetch_with_combined_mapping_and_adapters(self, async_mapped_table_backend):
        """
