# tests/rhosocial/activerecord_test/feature/backend/backend/test_config.py
import os
import sqlite3
...
class TestSQLiteConnectionConfig:
    ...
    def test_to_dict(self):
        ...
        config = SQLiteConnectionConfig(database="test.db", uri=True, pragmas={"journal_mode": "WAL"})
    ...
    def test_clone(self):
        ...
        config1 = SQLiteConnectionConfig(database="original.db", pragmas={"journal_mode": "DELETE"})
