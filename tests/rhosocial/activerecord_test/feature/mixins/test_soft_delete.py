# tests/rhosocial/activerecord_test/feature/mixins/test_soft_delete.py
"""
Soft Delete Mixin Tests

Directly import and run the testsuite's soft delete mixin tests.
"""
...
# Fixtures (e.g., soft_delete_model) are automatically discovered by pytest from `conftest.py` files
