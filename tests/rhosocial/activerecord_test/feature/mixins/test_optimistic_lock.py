...
"""
Optimistic Locking Mixin Tests

Directly import and run the testsuite's optimistic locking mixin tests.
"""
...
# Fixtures (e.g., optimistic_locking_model) are automatically discovered by pytest from `conftest.py` files
