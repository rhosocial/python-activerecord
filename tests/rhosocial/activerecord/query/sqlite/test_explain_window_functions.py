...
def test_explain_row_number(order_fixtures, skip_if_unsupported, request):
...
def test_explain_window_with_partition(order_fixtures, skip_if_unsupported, request):
...
def test_explain_multiple_window_functions(order_fixtures, skip_if_unsupported, request):
...
def test_explain_window_with_frame(order_fixtures, skip_if_unsupported, request):
...
def test_explain_window_with_joins(order_fixtures, skip_if_unsupported, request):
...
def test_explain_window_with_filter(order_fixtures, skip_if_unsupported, request):
...
def test_explain_window_with_grouping(order_fixtures, skip_if_unsupported, request):
...
def test_explain_named_windows(order_fixtures, skip_if_unsupported, request):
