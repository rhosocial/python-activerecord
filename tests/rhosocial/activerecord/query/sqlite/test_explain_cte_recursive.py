...
from tests.rhosocial.activerecord.query.utils import create_tree_fixtures
...
def test_explain_recursive_cte_basic(tree_fixtures, skip_if_unsupported, request):
...
def test_explain_recursive_cte_with_depth_limit(tree_fixtures, skip_if_unsupported, request):
...
def test_explain_recursive_cte_path_finding(tree_fixtures, skip_if_unsupported, request):
