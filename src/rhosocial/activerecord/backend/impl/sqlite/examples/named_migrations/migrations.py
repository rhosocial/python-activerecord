# src/rhosocial/activerecord/backend/impl/sqlite/examples/named_migrations/migrations.py
"""
NamedMigration subclasses for migration examples.
...
class V001CreateUsers(NamedMigration):
    ...
    def up(self, ctx: MigrationContext) -> None:
        ctx.execute(
            "rhosocial.activerecord.backend.impl.sqlite.examples.named_migrations"
