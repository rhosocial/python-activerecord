# tests/rhosocial/activerecord_test/query/sqlite/test_explain_cte_basic.py
...
def test_explain_basic_cte(order_fixtures, request):
...
def test_explain_cte_with_parameters(order_fixtures, request):
...
def test_explain_cte_format_options(order_fixtures, request):
...
def test_explain_cte_with_conditions(order_fixtures, request):
